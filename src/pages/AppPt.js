...
class App extends Component {
  ...
  render() {
    ...
    */
    ...
    /*Pegando o ano de uma data no formato MM/DD/YYYY*/
    ...
    /*Pegando o mês de uma data no formato MM/DD/YYYY*/
    /*
    ...
    */
    ...
    /*Pegando os dias de uma data no formato MM/DD/YYYY*/
    /*
    ...
    */
    ...
    /*Pegando o ano de uma data no formato YYYY-MM-DDTHH:MM:SSZ*/
    ...
    /*Pegando o mês de uma data no formato YYYY-MM-DDTHH:MM:SSZ*/
    /*
    ...
    */
    ...
    /*Pegando os dias de uma data no formato YYYY-MM-DDTHH:MM:SSZ*/
    /*
    ...
    */
    ...
    const truckFactor = (lista, cct) => { 
      ...
      if(tf===0){ tf = 1; } //exception

      return tf;
    }

    /*Função que retorna o(s) principal(is) mantenedor(es) de uma lista ou o grupo de mantenedores*/
    const mantenedor = (lista, truckFactor) => {	
      ...
      if(truckFactor===1){
        return "Caso " +listaNome[0] +" abandone este projeto, provavelmente não haverá continuidade.";
      }
        ...
        return mantenedores +" são os principais mantenedores deste projeto.";
    ...
    if (empresa === 'facebook' || empresa === 'FACEBOOK'){
      ...
      console.log('Sucesso! Org: ' + empresa);
    }
      ...
      dataOrg = data;
      console.log('Erro! Org: ' + empresa);
    }

    return (
      <div className="container App pt">
       
        {/*Cabeçalho do githubData em PT*/}
        <Navbar  
          classeNameDiv="card card-body mt-3 mb-3 text-center"
          itemH1="API Github"
          itemStrong1="Os projetos mais populares do Github!" 
          itemStrong2="Ordenados por quantidade de estrelas."
          itemStrong3="Escolha a organização: "
          idSelect="org"
          ...
          <div className="card card-body mt-3 mb-3 text-center">
            <div className="row bg-row">
              <CSVLink 
                data={dataOrg} 
                headers={headersOrg}
                filename={"relatorio_truck_factor.csv"} 
                enclosingCharacter={`'`} 
                separator={";"}
              >
                Relatório Truck Factor
              </CSVLink>
            </div>             
          </div>
            ...
            {githubData.map((name, index) => (
              <div className="col-sm-6 col-md-4 col-lg-3 repositorios" key={name.id}>
                ...
                <div className="repo-content">
                  <ApiItem itemName="Projeto: " item={name.name} classe="read-more" />
                  <ApiItem itemName="Linguagem: " item={name.language} />
                  <ApiItem itemName="Idade (Anos): " item={idadeRepo(name.created_at)} />
                  <ApiItem itemName="Organização: " item={name.owner.login} />
                  <ApiItem itemName="Descrição: " item={name.description} classe="read-more" />
                ...
                <Modal 
                  ...
                  <ApiInfor                    
                    ...
                    item5={
                      <ApiItem 
                        itemName="Truck Factor do Projeto: " 
                        item={ 
                          truckFactor(
                            listaCommitsPag1, 
                            cct(commitsPag1 + commitsPag2 + commitsPag3 + commitsPag4 + commitsPag5)
                  ...
                  {githubRepo.map((name, index) => (
                    <div key={name.id} className="col-md-12 pull-request">                          
                      ...
                      <ApiInfor 
                        classeNameDiv="card card-body mt-3 mb-3 text-center"                                            
                        item1={ <ApiItem classe="pull-body" itemName="Desenvolvedor: " item={name.login}/> }
